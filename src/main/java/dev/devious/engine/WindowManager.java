...
public class WindowManager {
    ...
    public void init() {
        ...
        if (window == MemoryUtil.NULL) throw new RuntimeException("Could not create GLFW window");
        ...
        if (isWindowMaximized) {
            ...
            GLFW.glfwSetWindowPos(
                window,
                ((videoMode != null ? videoMode.width() : 0) - width) / 2,
                ((videoMode != null ? videoMode.height() : 0) - height) / 2
            );
        }
